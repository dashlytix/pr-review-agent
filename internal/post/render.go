...
func RenderReviewReview(result provider.ReviewResult, sha string, conflicting bool) (string, []ReviewComment) {
	...
	if conflicting {
		b.WriteString("> ⚠️ **This PR has merge conflicts with its base branch.** GitHub reports it cannot be merged as-is — the review below is based on the diff as submitted.\n\n")
	}
